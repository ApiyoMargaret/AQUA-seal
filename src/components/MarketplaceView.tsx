        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-teal-100/90 mt-1 max-w-xl leading-relaxed">
              Connect directly with artisanal fishers. Every batch comes with certified BMU landing provenance and solar cold-chain evidence.
              <strong className="text-teal-200"> 0% fisher registration fees • 1.5% transparent direct-sale buyer fee.</strong>
            </p>
          </div>
